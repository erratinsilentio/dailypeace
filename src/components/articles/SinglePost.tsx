            ...
            <article className="flex flex-row w-[800px] h-[240px]" key={post.slug}>
                ...
                <div className="flex flex-col px-8 py-2">
                    <span className="flex flex-row items-center justify-start">
                        <span className="text-stone-500 pr-6 text-[14px]">
                    ...
                    <span className="text-[20px] py-2">{post.data.title}</span>
                    <span className="text-stone-600 text-[16px]">{post.data.description}</span>
                    <a href="#" className="py-4">
                        <span className="text-[18px] text-stone-900 hover:underline">Read More...</span>
                    </a>
                </div>
            </article>
    )
